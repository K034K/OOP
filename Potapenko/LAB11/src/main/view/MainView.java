...
public class MainView extends JFrame {
    ...
    private JMenuItem AddListenerMenu;
    private JMenuItem RemoveListenerMenu;
    private JMenu Lambda;
    private JMenuItem OverweightProductsMenu;
    private JMenuItem RemoveOverweightMenu;
    private JMenuItem MoveLongMenu;
    private JMenuItem ShowSortedMenu;
    ...
    private ProductStore lcs = new ProductStore();

    private ProductStore lts = new ProductStore();

    IProductListener listener = null;
    ...
    public MainView() {
        ...
        ShowSortedMenu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                showSorted();
            }
        ...
        AddListenerMenu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                addListener();
            }
        ...
        RemoveListenerMenu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                removeListener();
            }
        ...
        //Lambda menu
        OverweightProductsMenu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                showOverweightProducts();
            }
        });
        RemoveOverweightMenu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                removeOverweightProducts();
            }
        });
        MoveLongMenu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                moveLongProducts();
            }
    ...
    private void showSorted() {
        Output.append(ps.toSortedString());

    }

    private void moveLongProducts() {
        float length = Float.parseFloat(JOptionPane.showInputDialog("Enter length"));
        Predicate<Object> predicateTimber = new Predicate<Object>() {
            @Override
            public boolean test(Object o) {
                if (o instanceof Timber timber && timber.getLength() > length) {
                    lts.add(timber);
                    return true;
                }
                return false;
        ...
        Predicate<Object> predicateCylinder = new Predicate<Object>() {
            @Override
            public boolean test(Object o) {

                if (o instanceof Cylinder cylinder && cylinder.getHeight() > length) {
                    lcs.add(cylinder);
                    return true;
                }
        ...
        ps.remove(predicateTimber);
        ps.remove(predicateCylinder);
        Output.append("Long products moved to LongTimberStore and LongCylinderStore\n");
        Output.append("LongTimberStore: " + lts.toString() + "\n");
        Output.append("LongCylinderStore: " + lcs.toString() + "\n");
    }

    private void removeOverweightProducts() {
        float weight = Float.parseFloat(JOptionPane.showInputDialog("Enter weight"));
        Predicate<Object> predicate = new Predicate<Object>() {
            @Override
            public boolean test(Object o) {
                return o instanceof IWeight && ((IWeight) o).weight() > weight;
            }

        };
        ps.remove(predicate);
        Output.append("Remained products" + "\n");
        Output.append(ps.toString());


    }

    private void showOverweightProducts() {
        float weight = Float.parseFloat(JOptionPane.showInputDialog("Enter weight"));
        Output.append("Overweight products" + "\n");
        for (Object o : ps) {
            if (o instanceof IWeight && ((IWeight) o).weight() > weight) {
    ...
    private void removeListener() {
        ...
        Output.append("Listener removed" + "\n");
    }

    private void addListener() {
        IProductListener listener = new IProductListener() {
            @Override
            public void onProductEvent(event.ProductEvent event) {
                writeString(event.toString());
