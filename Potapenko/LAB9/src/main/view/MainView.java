...
public class MainView extends JFrame {
    ...
    private LongCylinderStore lcs = new LongCylinderStore();

    private LongTimberStore lts = new LongTimberStore();
    ...
    private void moveLongProducts() {
        ...
        lcs.doForAll((o) -> Output.append(o.toString() + "\n"));
        lts.doForAll((o) -> Output.append(o.toString() + "\n"));
    }
    ...
    private void showOverweightProducts() {
        ...
        ps.doOnlyFor((p) -> Output.append(p.toString() + "\n"), weight);
    }

    private void removeListener() {
        ps.removeProductListener(listener);
    }
